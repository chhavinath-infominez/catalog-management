...
import com.infominez.catalog.auth.feign.UserServiceFeign;
...
//			if (!user.getPassword().equals(loginForm.getPin())){
//				failedAttempts.add(currentTime);
//				return response.set(302, Constants.INCORRECT_MOBILE_NUMBER_AND_PIN);
//			}
...
//	}
	...
	public BaseResponse<User> getUserByPhone(String phone) {
		...
		try {
			BaseResponse<User> userResponse = userServiceFeign.getUserByPhone(phone);
